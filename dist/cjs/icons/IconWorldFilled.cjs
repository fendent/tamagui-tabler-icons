...
var IconWorldFilled_exports = {};
__export(IconWorldFilled_exports, {
  IconWorldFilled: () => IconWorldFilled
});
module.exports = __toCommonJS(IconWorldFilled_exports);
var import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  import_jsx_runtime = require("react/jsx-runtime");
const IconWorldFilled = (0, import_helpers_icon.themed)((0, import_react.memo)(function (props) {
  const {
    color = "black",
    size = 24,
    ...otherProps
