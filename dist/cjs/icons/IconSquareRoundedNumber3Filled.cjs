...
var IconSquareRoundedNumber3Filled_exports = {};
__export(IconSquareRoundedNumber3Filled_exports, {
  IconSquareRoundedNumber3Filled: () => IconSquareRoundedNumber3Filled
});
module.exports = __toCommonJS(IconSquareRoundedNumber3Filled_exports);
var import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  import_jsx_runtime = require("react/jsx-runtime");
const IconSquareRoundedNumber3Filled = (0, import_helpers_icon.themed)((0, import_react.memo)(function (props) {
  const {
    color = "black",
    size = 24,
    ...otherProps
