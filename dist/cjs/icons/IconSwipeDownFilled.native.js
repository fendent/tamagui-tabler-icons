...
var IconSwipeDownFilled_exports = {};
__export(IconSwipeDownFilled_exports, {
  IconSwipeDownFilled: () => IconSwipeDownFilled
});
module.exports = __toCommonJS(IconSwipeDownFilled_exports);
var import_jsx_runtime = require("react/jsx-runtime"),
  import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  IconSwipeDownFilled = (0, import_helpers_icon.themed)(/* @__PURE__ */(0, import_react.memo)(function (props) {
    var {
      color = "black",
      size = 24,
      ...otherProps
