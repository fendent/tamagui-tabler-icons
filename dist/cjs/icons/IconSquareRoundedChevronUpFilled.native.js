...
var IconSquareRoundedChevronUpFilled_exports = {};
__export(IconSquareRoundedChevronUpFilled_exports, {
  IconSquareRoundedChevronUpFilled: () => IconSquareRoundedChevronUpFilled
});
module.exports = __toCommonJS(IconSquareRoundedChevronUpFilled_exports);
var import_jsx_runtime = require("react/jsx-runtime"),
  import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  IconSquareRoundedChevronUpFilled = (0, import_helpers_icon.themed)(/* @__PURE__ */(0, import_react.memo)(function (props) {
    var {
      color = "black",
      size = 24,
      ...otherProps
