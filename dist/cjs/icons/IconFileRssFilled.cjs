...
var IconFileRssFilled_exports = {};
__export(IconFileRssFilled_exports, {
  IconFileRssFilled: () => IconFileRssFilled
});
module.exports = __toCommonJS(IconFileRssFilled_exports);
var import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  import_jsx_runtime = require("react/jsx-runtime");
const IconFileRssFilled = (0, import_helpers_icon.themed)((0, import_react.memo)(function (props) {
  const {
    color = "black",
    size = 24,
    ...otherProps
