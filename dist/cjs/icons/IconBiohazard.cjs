...
var IconBiohazard_exports = {};
__export(IconBiohazard_exports, {
  IconBiohazard: () => IconBiohazard
});
module.exports = __toCommonJS(IconBiohazard_exports);
var import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  import_jsx_runtime = require("react/jsx-runtime");
const IconBiohazard = (0, import_helpers_icon.themed)((0, import_react.memo)(function (props) {
  const {
    color = "black",
    size = 24,
    ...otherProps
