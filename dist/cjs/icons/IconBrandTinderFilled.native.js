...
var IconBrandTinderFilled_exports = {};
__export(IconBrandTinderFilled_exports, {
  IconBrandTinderFilled: () => IconBrandTinderFilled
});
module.exports = __toCommonJS(IconBrandTinderFilled_exports);
var import_jsx_runtime = require("react/jsx-runtime"),
  import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  IconBrandTinderFilled = (0, import_helpers_icon.themed)(/* @__PURE__ */(0, import_react.memo)(function (props) {
    var {
      color = "black",
      size = 24,
      ...otherProps
