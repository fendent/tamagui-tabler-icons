...
var IconCircleArrowDownRightFilled_exports = {};
__export(IconCircleArrowDownRightFilled_exports, {
  IconCircleArrowDownRightFilled: () => IconCircleArrowDownRightFilled
});
module.exports = __toCommonJS(IconCircleArrowDownRightFilled_exports);
var import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  import_jsx_runtime = require("react/jsx-runtime");
const IconCircleArrowDownRightFilled = (0, import_helpers_icon.themed)((0, import_react.memo)(function (props) {
  const {
    color = "black",
    size = 24,
    ...otherProps
