...
var IconHexagonLetterN_exports = {};
__export(IconHexagonLetterN_exports, {
  IconHexagonLetterN: () => IconHexagonLetterN
});
module.exports = __toCommonJS(IconHexagonLetterN_exports);
var import_jsx_runtime = require("react/jsx-runtime"),
  import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  IconHexagonLetterN = (0, import_helpers_icon.themed)(/* @__PURE__ */(0, import_react.memo)(function (props) {
    var {
      color = "black",
      size = 24,
      ...otherProps
