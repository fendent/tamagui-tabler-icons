...
var IconHomeLink_exports = {};
__export(IconHomeLink_exports, {
  IconHomeLink: () => IconHomeLink
});
module.exports = __toCommonJS(IconHomeLink_exports);
var import_jsx_runtime = require("react/jsx-runtime"),
  import_react = require("react"),
  import_react_native_svg = require("react-native-svg"),
  import_helpers_icon = require("@tamagui/helpers-icon"),
  IconHomeLink = (0, import_helpers_icon.themed)(/* @__PURE__ */(0, import_react.memo)(function (props) {
    var {
      color = "black",
      size = 24,
      ...otherProps
